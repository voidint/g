# go-update: Build self-updating Go programs [![godoc reference](https://godoc.org/github.com/voidint/go-update?status.png)](https://godoc.org/github.com/voidint/go-update)
...
- **Aug 9, 2015**: 2.0 API. Old API at `221d034` or `gopkg.in/voidint/go-update.v0`.
